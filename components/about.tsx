      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            I'm a passionate full-stack developer with 2 years of hands-on experience building practical and user-focused digital solutions. 
            I enjoy breaking down complex problems and turning them into clean, intuitive applications. Always eager to learn and grow, 
            I'm currently looking for remote opportunities to apply my skills, gain real-world experience, and contribute to meaningful projects.
          </p>
        </div>
